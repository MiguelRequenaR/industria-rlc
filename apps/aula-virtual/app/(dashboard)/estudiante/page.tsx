...
import { BookOpen, FileText, Trophy, Calendar } from 'lucide-react';

export default function EstudianteDashboardPage() {
  const estudianteSections = [
    {
      title: 'Mis Cursos',
    ...
    {
      title: 'Tareas',
      description: 'Entregas y calificaciones',
    ...
    },
    {
      ...
      description: 'Ver tu progreso y notas',
    ...
    {
      title: 'Calendario',
      description: 'Próximas clases y eventos',
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Mi Aula Virtual</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2">
        {estudianteSections.map((section) => {
