    ...
    <section
      ...
      <div
        ...
        <div
          ...
          <div data-aos="fade-up">
            <Image src="https://images.unsplash.com/photo-1683295083329-4d4738291f3a?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Carta a nuestros clientes" width={500} height={500} className="md:rounded-2xl" loading="lazy" />
          </div>
        </div>
        <div
