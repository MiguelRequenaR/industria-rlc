...
export default function HeroHome() {
  ...
  const messageLink = "https://wa.me/51940162009?text=Hola, requiero una asesoría técnica."
  ...
  return (
    <section className="relative w-full h-[80vh] min-h-80 flex items-center overflow-hidden pt-24">
